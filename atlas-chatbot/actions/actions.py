...
class ActionProvideSummary(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        return []
class ActionProvideDailySummary(Action):

    def name(self) -> Text:
        return "action_provide_daily_summary"
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        summary = f"Here is your DAILY absence request: Precard type: daily absence, From Date: {from_date}, To Date: {to_date}.  from .py"
        dispatcher.utter_message(text=summary)
